/**
   Bluetooth enter 1 to start, 0 to stop
*/
...
int outputPin = 5; //define pint for sensor trig
...
void setup()
{
  ...
  myservo.attach(9); // define servo motor output pin to D9 (PWN)
}
...
void loop()
{
  while (Serial.available() > 0) { // if received UART data
